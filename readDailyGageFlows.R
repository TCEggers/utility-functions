...
readDailyGageFlows <- function(station_sensor_list = NA,
    ...
    if (is.na(station_sensor_list)) {
        station_sensor_list <- data.frame(
            ...
            sensor = c(20, 23, 20, 20, 20, 20, 23, 20, 20, 20, 20, 20, 20, 20, 20,
                       71, 20, 20, 23, 23, 20),
            dur_code = c("H", "H", "H", "E", "E", "H", "H", "E", "E", "E", "H", "H",
                         "H", "E", "H", "D", "H", "E", "H", "H", "H"),
            sensor_description = c("Flow, River Discharge (cfs)", 
