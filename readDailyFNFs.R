...
# Scrapes daily Full Natural Flow (FNF) values from DWR's CDEC web site.
# FNF values are in cubic feet per second (cfs).
#
# Changes:
#       2015-10-14: Added ability to specify Enddate
#       2015-10-29: Added destring helper function here
#
